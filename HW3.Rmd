...
### "High" income consumers attain `$``r round(social_high,0)` of benefit and "Low" income consumers  attain `$``r round(social_low,0)` of benefit for a total of `$``r round(social_tot,0)`. "High" income consumers receive %`r round(high_percentage,0)` of the total benefit.
