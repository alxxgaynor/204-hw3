...
author: "Alex Gaynor, Carlos Simms, Iris Foxfoot"
output:
  html_document:
    code_folding: hide
    theme: journal
...
### "high" income consumers attain `$``r round(social_high,1)` of benefit and "Low" income consumers  attain `$``r round(social_low,1)` of benefit
...
# tax revenue ? environemntal damage
