...
benefit_table <- tibble(x = c(51,
                        ...
                        p <- producer_surplus(x)) %>% 
  round(digits = 2)
>>>>>>> 2017786f818c7904cf01f8facfcfff23cfbf9b38
...
demand_electric(3,model_demand_high)
demand(3,model_demand_low)

e_gas_tot <- demand_electric(3,model_demand_high) +
  demand(3,model_demand_low)
# Social benefit - electric:

social_low = (a_low-3)*(demand(3,model_demand_low))/2

social_high_e = ((a_high/2)-3)*(demand_electric(3,model_demand_high))/2
